    ...
    <>
      ...
      <aside
        ...
        className={[
          ...
          // wrapping onto several lines before the width caught up.
          'fixed left-0 top-0 z-50 flex h-dvh md:h-screen w-64 flex-col bg-emerald-950 dark:bg-slate-950 text-emerald-50 dark:text-emerald-400 border-r border-white/5 shadow-2xl transition-transform duration-300 ease-in-out overflow-y-auto overflow-x-hidden',
